...
class Funcs():
    ...
    def gerenciar_clientes(self):
        ...
        self.lb_cnpj_reu = ttk.Label(self.frame_cliente, text = "CNPJ Réu")
...
class App(Funcs):
    ...
    def widgets_frame1(self):
        ...
        self.bt_consultar_doc = ttk.Button(self.frame_menu, text="Consultar Documentos")
        self.bt_consultar_doc.place(relx= 0.05, rely=0.51, relwidth=0.9, relheight=0.05)
