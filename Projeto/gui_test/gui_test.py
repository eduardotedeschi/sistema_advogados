"""A demo script to showcase the Sun Valley ttk theme, with added validation from example.py."""
...
class InputsAndButtonsDemo(ttk.Frame):
    def __init__(self, parent):
        ...
        self.add_widgets()
        self.bind_them()  # Adicionado para vincular os eventos de validação
    ...
    def add_widgets(self):
        ...
        # Novos campos de entrada para validação, vindos de example.py
        self.int_entry = ttk.Entry(self)
        self.int_entry.grid(row=1, column=0, padx=5, pady=5, sticky="ew")

        self.color_entry = ttk.Entry(self)
        self.color_entry.grid(row=2, column=0, padx=5, pady=5, sticky="ew")
        ...
        self.readonly_combo.grid(row=5, column=0, padx=5, pady=10, sticky="ew")
        ...
        self.menubutton.grid(row=6, column=0, padx=5, pady=10, sticky="nsew")

        self.separator = ttk.Separator(self)
        self.separator.grid(row=7, column=0, pady=10, sticky="ew")
        ...
        self.accentbutton.grid(row=9, column=0, padx=5, pady=10, sticky="ew")
    ...
    def bind_them(self):
        self.int_entry.insert(0, "Type here (Wrong if no numbers)")
        self.int_entry.bind("<FocusOut>", self.validate_int)
        self.int_entry.bind("<FocusIn>", self.validate_int)
        self.int_entry.bind("<KeyRelease>", self.validate_int)

        self.color_entry.insert(0, "Type here (Always wrong)")
...
class App(ttk.Frame):
    def __init__(self, parent):
        ...
        PanedDemo(self).grid(row=0, column=2, columnspan=2, rowspan=2, padx=10, pady=(10, 0), sticky="nsew")


def main():
    root = tkinter.Tk()
    root.title("Sun Valley Theme Demo")
    ...
    # Ajustes de geometria para centralizar a janela e garantir o tamanho mínimo
